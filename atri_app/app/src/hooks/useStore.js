...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox36": {
      "custom": {
        "text": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea voluptas quas distinctio! Blanditiis autem architecto illo odio sed eveniet inventore, perspiciatis natus, fugiat molestias qui obcaecati neque quibusdam molestiae iure."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image29": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/kisspng-computer-icons-facebook-messenger-black-and-white-icon-5adfcaad1a5fa6.1442364715246158531081.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image31": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Black-icon-Instagram-logo-transparent-PNG.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image34": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/linkedin-icon-1-logo-png-transparent.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image35": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/youtube-transparent-logo-play-button-23.png"
      },
      "callbacks": {
        "onClick": [
          {
